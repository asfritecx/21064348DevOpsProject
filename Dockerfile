...
COPY ./configurations/plugins.json /app/App_Data/plugins.json
COPY ./configurations/appsettings.json /app/App_Data/appsettings.json
RUN chmod 755 /entrypoint.sh
RUN chmod 755 /app/App_Data/plugins.json
RUN chmod 755 /app/App_Data/appsettings.json
