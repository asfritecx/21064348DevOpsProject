...
namespace Nop.Data.Configuration
{
    public partial class DataConfig : IConfig, IConnectionStringAccessor
    {
        ...
        /// </summary>
        public string ConnectionString { get; set; } = "server=server;database=marvelodb;allowuservariables=True;userid=;password=";

        /// <summary>
        /// Gets or sets a data provider
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public DataProviderType DataProvider { get; set; } = DataProviderType.MySql;
